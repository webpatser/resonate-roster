...
namespace Webpatser\ResonateRoster\Tests;
...
class TestCase extends Testbench
{
     ...
     *
     * Mirrors Resonate's own single-app `config/reverb.php` shape and points
     * the roster at Redis database 15, a throwaway the suite is free to flush.
     */
