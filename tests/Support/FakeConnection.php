...
namespace Webpatser\ResonateRoster\Tests\Support;
 ...
 *
 * It skips the base constructor (which expects a live WebSocket) and carries
 * a fixed socket id and application, which is all the roster plugin reads.
 */
